    ...
    <div class="container">
        <div class="row">
            <div class="slider">
                ...
                <div id="header-text">
                    <marquee behavior="scroll" direction="left"><h1>PLEASE <strong style="color:#11B57C;">CLICK</strong> ON THE <strong style="color:#11B57C;">ADMIN</strong> BUTTON ON THE TOP FOR <strong style="color:#11B57C;">CRUD OPERATION</strong></h1></marquee>
                </div>
            </div>
